...
/**
 * <p>Java class for CertMgrRefreshCACertificatesAndCRLsRequestType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CertMgrRefreshCACertificatesAndCRLsRequestType">
 *   <complexContent>
...
@XmlType(name = "CertMgrRefreshCACertificatesAndCRLsRequestType", propOrder = {
    "_this",
    "host"
})
