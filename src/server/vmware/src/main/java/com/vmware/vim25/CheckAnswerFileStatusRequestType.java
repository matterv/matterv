...
/**
 * <p>Java class for CheckAnswerFileStatusRequestType complex type</p>.
 * 
...
@XmlType(name = "CheckAnswerFileStatusRequestType", propOrder = {
    "_this",
    "host"
})
public class CheckAnswerFileStatusRequestType {
