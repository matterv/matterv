...
/**
 * <p>Java class for DeleteVmfsVolumeStateRequestType complex type</p>.
 * 
...
@XmlType(name = "DeleteVmfsVolumeStateRequestType", propOrder = {
    "_this",
    "vmfsUuid"
})
public class DeleteVmfsVolumeStateRequestType {
