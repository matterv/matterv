...
/**
 * <p>Java class for ArrayOfVirtualMachineConfigOptionDescriptor complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VirtualMachineConfigOptionDescriptor" type="{urn:internalvim25}VirtualMachineConfigOptionDescriptor" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVirtualMachineConfigOptionDescriptor {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachineConfigOptionDescriptor property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the virtualMachineConfigOptionDescriptor property.
     */
    public List<VirtualMachineConfigOptionDescriptor> getVirtualMachineConfigOptionDescriptor() {
        if (virtualMachineConfigOptionDescriptor == null) {
            virtualMachineConfigOptionDescriptor = new ArrayList<>();
        }
