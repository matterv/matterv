...
/**
 * <p>Java class for ArrayOfOvfResourceMap complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="OvfResourceMap" type="{urn:internalvim25}OvfResourceMap" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfOvfResourceMap {
     ...
     * This is why there is not a <CODE>set</CODE> method for the ovfResourceMap property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the ovfResourceMap property.
     */
    public List<OvfResourceMap> getOvfResourceMap() {
        if (ovfResourceMap == null) {
            ovfResourceMap = new ArrayList<>();
        }
