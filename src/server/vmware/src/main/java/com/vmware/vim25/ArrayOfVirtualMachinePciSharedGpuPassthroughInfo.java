...
/**
 * <p>Java class for ArrayOfVirtualMachinePciSharedGpuPassthroughInfo complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VirtualMachinePciSharedGpuPassthroughInfo" type="{urn:internalvim25}VirtualMachinePciSharedGpuPassthroughInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVirtualMachinePciSharedGpuPassthroughInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachinePciSharedGpuPassthroughInfo property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the virtualMachinePciSharedGpuPassthroughInfo property.
     */
    public List<VirtualMachinePciSharedGpuPassthroughInfo> getVirtualMachinePciSharedGpuPassthroughInfo() {
        if (virtualMachinePciSharedGpuPassthroughInfo == null) {
            virtualMachinePciSharedGpuPassthroughInfo = new ArrayList<>();
        }
