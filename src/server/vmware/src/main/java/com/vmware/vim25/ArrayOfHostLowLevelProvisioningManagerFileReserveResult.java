...
/**
 * <p>Java class for ArrayOfHostLowLevelProvisioningManagerFileReserveResult complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostLowLevelProvisioningManagerFileReserveResult" type="{urn:internalvim25}HostLowLevelProvisioningManagerFileReserveResult" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostLowLevelProvisioningManagerFileReserveResult {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostLowLevelProvisioningManagerFileReserveResult property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostLowLevelProvisioningManagerFileReserveResult property.
     */
    public List<HostLowLevelProvisioningManagerFileReserveResult> getHostLowLevelProvisioningManagerFileReserveResult() {
        if (hostLowLevelProvisioningManagerFileReserveResult == null) {
            hostLowLevelProvisioningManagerFileReserveResult = new ArrayList<>();
        }
