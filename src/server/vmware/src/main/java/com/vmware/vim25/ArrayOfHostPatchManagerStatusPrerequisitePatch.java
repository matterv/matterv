...
/**
 * <p>Java class for ArrayOfHostPatchManagerStatusPrerequisitePatch complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostPatchManagerStatusPrerequisitePatch" type="{urn:internalvim25}HostPatchManagerStatusPrerequisitePatch" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostPatchManagerStatusPrerequisitePatch {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostPatchManagerStatusPrerequisitePatch property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostPatchManagerStatusPrerequisitePatch property.
     */
    public List<HostPatchManagerStatusPrerequisitePatch> getHostPatchManagerStatusPrerequisitePatch() {
        if (hostPatchManagerStatusPrerequisitePatch == null) {
            hostPatchManagerStatusPrerequisitePatch = new ArrayList<>();
        }
