...
/**
 * <p>Java class for QueryConnectionInfoViaSpecRequestType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="QueryConnectionInfoViaSpecRequestType">
 *   <complexContent>
...
@XmlType(name = "QueryConnectionInfoViaSpecRequestType", propOrder = {
    "_this",
    "spec"
})
