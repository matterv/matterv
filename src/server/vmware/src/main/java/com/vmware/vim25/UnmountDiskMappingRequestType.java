...
/**
 * <p>Java class for UnmountDiskMappingRequestType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="UnmountDiskMappingRequestType">
 *   <complexContent>
...
@XmlType(name = "UnmountDiskMappingRequestType", propOrder = {
    "_this",
    "mapping"
})
