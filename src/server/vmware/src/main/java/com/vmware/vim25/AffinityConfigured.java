...
/**
 * <p>Java class for AffinityConfigured complex type</p>.
 * 
    ...
    extends MigrationFault
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the configuredAffinity property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the configuredAffinity property.
     */
    public List<String> getConfiguredAffinity() {
        if (configuredAffinity == null) {
            configuredAffinity = new ArrayList<>();
        }
