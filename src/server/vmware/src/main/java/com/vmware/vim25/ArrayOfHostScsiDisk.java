...
/**
 * <p>Java class for ArrayOfHostScsiDisk complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostScsiDisk" type="{urn:internalvim25}HostScsiDisk" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostScsiDisk {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostScsiDisk property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostScsiDisk property.
     */
    public List<HostScsiDisk> getHostScsiDisk() {
        if (hostScsiDisk == null) {
            hostScsiDisk = new ArrayList<>();
        }
