...
/**
 * <p>Java class for HostPlugStoreTopologyPlugin complex type</p>.
 * 
    ...
    extends DynamicData
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the claimedPath property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the claimedPath property.
     */
    public List<String> getClaimedPath() {
        if (claimedPath == null) {
            claimedPath = new ArrayList<>();
        }
