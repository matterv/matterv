...
/**
 * <p>Java class for InstallHostPatchV2RequestType complex type</p>.
 * 
...
public class InstallHostPatchV2RequestType {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the vibUrls property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the vibUrls property.
     */
    public List<String> getVibUrls() {
        if (vibUrls == null) {
            vibUrls = new ArrayList<>();
        }
        return this.vibUrls;
    }
