...
/**
 * <p>Java class for DatastoreVVolContainerFailoverPair complex type</p>.
 * 
 ...
 *         <element name="vvolMapping" type="{urn:internalvim25}KeyValue" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
    ...
    extends DynamicData
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the vvolMapping property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the vvolMapping property.
     */
    public List<KeyValue> getVvolMapping() {
        if (vvolMapping == null) {
            vvolMapping = new ArrayList<>();
        }
