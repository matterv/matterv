...
/**
 * <p>Java class for ArrayOfHostPowerPolicy complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostPowerPolicy" type="{urn:internalvim25}HostPowerPolicy" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostPowerPolicy {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostPowerPolicy property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostPowerPolicy property.
     */
    public List<HostPowerPolicy> getHostPowerPolicy() {
        if (hostPowerPolicy == null) {
            hostPowerPolicy = new ArrayList<>();
        }
