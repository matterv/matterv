...
/**
 * <p>Java class for ArrayOfHostSystemSwapConfigurationSystemSwapOption complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostSystemSwapConfigurationSystemSwapOption" type="{urn:internalvim25}HostSystemSwapConfigurationSystemSwapOption" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostSystemSwapConfigurationSystemSwapOption {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostSystemSwapConfigurationSystemSwapOption property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostSystemSwapConfigurationSystemSwapOption property.
     */
    public List<HostSystemSwapConfigurationSystemSwapOption> getHostSystemSwapConfigurationSystemSwapOption() {
        if (hostSystemSwapConfigurationSystemSwapOption == null) {
            hostSystemSwapConfigurationSystemSwapOption = new ArrayList<>();
        }
