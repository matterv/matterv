...
/**
 * <p>Java class for ArrayOfLocalizationManagerMessageCatalog complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="LocalizationManagerMessageCatalog" type="{urn:internalvim25}LocalizationManagerMessageCatalog" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfLocalizationManagerMessageCatalog {
     ...
     * This is why there is not a <CODE>set</CODE> method for the localizationManagerMessageCatalog property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the localizationManagerMessageCatalog property.
     */
    public List<LocalizationManagerMessageCatalog> getLocalizationManagerMessageCatalog() {
        if (localizationManagerMessageCatalog == null) {
            localizationManagerMessageCatalog = new ArrayList<>();
        }
