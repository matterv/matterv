...
/**
 * <p>Java class for ArrayOfClusterGroupSpec complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="ClusterGroupSpec" type="{urn:internalvim25}ClusterGroupSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfClusterGroupSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the clusterGroupSpec property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the clusterGroupSpec property.
     */
    public List<ClusterGroupSpec> getClusterGroupSpec() {
        if (clusterGroupSpec == null) {
            clusterGroupSpec = new ArrayList<>();
        }
