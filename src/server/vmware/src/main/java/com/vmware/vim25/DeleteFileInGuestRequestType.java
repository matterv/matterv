...
/**
 * <p>Java class for DeleteFileInGuestRequestType complex type</p>.
 * 
...
@XmlType(name = "DeleteFileInGuestRequestType", propOrder = {
    "_this",
    "vm",
    "auth",
    "filePath"
})
public class DeleteFileInGuestRequestType {
