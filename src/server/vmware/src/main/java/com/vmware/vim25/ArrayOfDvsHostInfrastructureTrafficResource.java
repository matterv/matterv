...
/**
 * <p>Java class for ArrayOfDvsHostInfrastructureTrafficResource complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="DvsHostInfrastructureTrafficResource" type="{urn:internalvim25}DvsHostInfrastructureTrafficResource" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfDvsHostInfrastructureTrafficResource {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dvsHostInfrastructureTrafficResource property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dvsHostInfrastructureTrafficResource property.
     */
    public List<DvsHostInfrastructureTrafficResource> getDvsHostInfrastructureTrafficResource() {
        if (dvsHostInfrastructureTrafficResource == null) {
            dvsHostInfrastructureTrafficResource = new ArrayList<>();
        }
