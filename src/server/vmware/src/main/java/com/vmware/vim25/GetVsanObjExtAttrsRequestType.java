...
/**
 * <p>Java class for GetVsanObjExtAttrsRequestType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GetVsanObjExtAttrsRequestType">
 *   <complexContent>
...
@XmlType(name = "GetVsanObjExtAttrsRequestType", propOrder = {
    "_this",
    "uuids"
})
