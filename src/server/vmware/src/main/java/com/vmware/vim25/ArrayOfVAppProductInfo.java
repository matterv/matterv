...
/**
 * <p>Java class for ArrayOfVAppProductInfo complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VAppProductInfo" type="{urn:internalvim25}VAppProductInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVAppProductInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vAppProductInfo property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the vAppProductInfo property.
     */
    public List<VAppProductInfo> getVAppProductInfo() {
        if (vAppProductInfo == null) {
            vAppProductInfo = new ArrayList<>();
        }
