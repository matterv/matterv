...
/**
 * <p>Java class for ImportHostAddFailure complex type</p>.
 * 
    ...
    extends DvsFault
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostIp property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostIp property.
     */
    public List<String> getHostIp() {
        if (hostIp == null) {
            hostIp = new ArrayList<>();
        }
        return this.hostIp;
    }
