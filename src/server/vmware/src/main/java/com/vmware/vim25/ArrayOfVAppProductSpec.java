...
/**
 * <p>Java class for ArrayOfVAppProductSpec complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VAppProductSpec" type="{urn:internalvim25}VAppProductSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVAppProductSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vAppProductSpec property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the vAppProductSpec property.
     */
    public List<VAppProductSpec> getVAppProductSpec() {
        if (vAppProductSpec == null) {
            vAppProductSpec = new ArrayList<>();
        }
