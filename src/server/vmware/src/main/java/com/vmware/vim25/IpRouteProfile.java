...
/**
 * <p>Java class for IpRouteProfile complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="staticRoute" type="{urn:internalvim25}StaticRouteProfile" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
    ...
    extends ApplyProfile
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the staticRoute property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the staticRoute property.
     */
    public List<StaticRouteProfile> getStaticRoute() {
        if (staticRoute == null) {
            staticRoute = new ArrayList<>();
        }
