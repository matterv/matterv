...
/**
 * <p>Java class for ArrayOfDistributedVirtualSwitchHostProductSpec complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="DistributedVirtualSwitchHostProductSpec" type="{urn:internalvim25}DistributedVirtualSwitchHostProductSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfDistributedVirtualSwitchHostProductSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the distributedVirtualSwitchHostProductSpec property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the distributedVirtualSwitchHostProductSpec property.
     */
    public List<DistributedVirtualSwitchHostProductSpec> getDistributedVirtualSwitchHostProductSpec() {
        if (distributedVirtualSwitchHostProductSpec == null) {
            distributedVirtualSwitchHostProductSpec = new ArrayList<>();
        }
