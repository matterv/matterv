...
/**
 * <p>Java class for ArrayOfVsanUpgradeSystemUpgradeHistoryItem complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VsanUpgradeSystemUpgradeHistoryItem" type="{urn:internalvim25}VsanUpgradeSystemUpgradeHistoryItem" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVsanUpgradeSystemUpgradeHistoryItem {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vsanUpgradeSystemUpgradeHistoryItem property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the vsanUpgradeSystemUpgradeHistoryItem property.
     */
    public List<VsanUpgradeSystemUpgradeHistoryItem> getVsanUpgradeSystemUpgradeHistoryItem() {
        if (vsanUpgradeSystemUpgradeHistoryItem == null) {
            vsanUpgradeSystemUpgradeHistoryItem = new ArrayList<>();
        }
