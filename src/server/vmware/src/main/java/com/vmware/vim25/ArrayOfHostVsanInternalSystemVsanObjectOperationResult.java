...
/**
 * <p>Java class for ArrayOfHostVsanInternalSystemVsanObjectOperationResult complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostVsanInternalSystemVsanObjectOperationResult" type="{urn:internalvim25}HostVsanInternalSystemVsanObjectOperationResult" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostVsanInternalSystemVsanObjectOperationResult {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostVsanInternalSystemVsanObjectOperationResult property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostVsanInternalSystemVsanObjectOperationResult property.
     */
    public List<HostVsanInternalSystemVsanObjectOperationResult> getHostVsanInternalSystemVsanObjectOperationResult() {
        if (hostVsanInternalSystemVsanObjectOperationResult == null) {
            hostVsanInternalSystemVsanObjectOperationResult = new ArrayList<>();
        }
