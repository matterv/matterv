...
/**
 * <p>Java class for AcquireCredentialsInGuestRequestType complex type</p>.
 * 
 ...
 *         <element name="requestedAuth" type="{urn:internalvim25}GuestAuthentication"/>
...
@XmlType(name = "AcquireCredentialsInGuestRequestType", propOrder = {
    "_this",
    "vm",
    "requestedAuth",
    "sessionID"
...
public class AcquireCredentialsInGuestRequestType {
     ...
     *     
     */
    public void setRequestedAuth(GuestAuthentication value) {
        this.requestedAuth = value;
    }
