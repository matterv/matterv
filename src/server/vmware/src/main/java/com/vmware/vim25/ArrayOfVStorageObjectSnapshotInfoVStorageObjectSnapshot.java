...
/**
 * <p>Java class for ArrayOfVStorageObjectSnapshotInfoVStorageObjectSnapshot complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VStorageObjectSnapshotInfoVStorageObjectSnapshot" type="{urn:internalvim25}VStorageObjectSnapshotInfoVStorageObjectSnapshot" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVStorageObjectSnapshotInfoVStorageObjectSnapshot {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vStorageObjectSnapshotInfoVStorageObjectSnapshot property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the vStorageObjectSnapshotInfoVStorageObjectSnapshot property.
     */
    public List<VStorageObjectSnapshotInfoVStorageObjectSnapshot> getVStorageObjectSnapshotInfoVStorageObjectSnapshot() {
        if (vStorageObjectSnapshotInfoVStorageObjectSnapshot == null) {
            vStorageObjectSnapshotInfoVStorageObjectSnapshot = new ArrayList<>();
        }
