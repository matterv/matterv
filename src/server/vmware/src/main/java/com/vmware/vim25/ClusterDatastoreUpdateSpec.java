...
/**
 * <p>Java class for ClusterDatastoreUpdateSpec complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ClusterDatastoreUpdateSpec">
 *   <complexContent>
...
@XmlType(name = "ClusterDatastoreUpdateSpec", propOrder = {
    "datastore"
})
public class ClusterDatastoreUpdateSpec
