...
/**
 * <p>Java class for ArrayOfKmipServerInfo complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="KmipServerInfo" type="{urn:internalvim25}KmipServerInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfKmipServerInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the kmipServerInfo property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the kmipServerInfo property.
     */
    public List<KmipServerInfo> getKmipServerInfo() {
        if (kmipServerInfo == null) {
            kmipServerInfo = new ArrayList<>();
        }
