...
/**
 * <p>Java class for ArrayOfVirtualDiskId complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VirtualDiskId" type="{urn:internalvim25}VirtualDiskId" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVirtualDiskId {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualDiskId property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the virtualDiskId property.
     */
    public List<VirtualDiskId> getVirtualDiskId() {
        if (virtualDiskId == null) {
            virtualDiskId = new ArrayList<>();
        }
