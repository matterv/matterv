...
/**
 * <p>Java class for ArrayOfDvsFilterConfig complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="DvsFilterConfig" type="{urn:internalvim25}DvsFilterConfig" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfDvsFilterConfig {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dvsFilterConfig property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dvsFilterConfig property.
     */
    public List<DvsFilterConfig> getDvsFilterConfig() {
        if (dvsFilterConfig == null) {
            dvsFilterConfig = new ArrayList<>();
        }
