...
/**
 * <p>Java class for InitiateFileTransferFromGuestRequestType complex type</p>.
 * 
...
@XmlType(name = "InitiateFileTransferFromGuestRequestType", propOrder = {
    "_this",
    "vm",
    "auth",
    "guestFilePath"
})
public class InitiateFileTransferFromGuestRequestType {
