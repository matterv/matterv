...
/**
 * <p>Java class for AbdicateDomOwnershipRequestType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AbdicateDomOwnershipRequestType">
 *   <complexContent>
...
@XmlType(name = "AbdicateDomOwnershipRequestType", propOrder = {
    "_this",
    "uuids"
})
