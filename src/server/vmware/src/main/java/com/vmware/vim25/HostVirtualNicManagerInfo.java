...
/**
 * <p>Java class for HostVirtualNicManagerInfo complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="netConfig" type="{urn:internalvim25}VirtualNicManagerNetConfig" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
    ...
    extends DynamicData
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the netConfig property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the netConfig property.
     */
    public List<VirtualNicManagerNetConfig> getNetConfig() {
        if (netConfig == null) {
            netConfig = new ArrayList<>();
        }
