...
/**
 * <p>Java class for ArrayOfDvsTrafficRule complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="DvsTrafficRule" type="{urn:internalvim25}DvsTrafficRule" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfDvsTrafficRule {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dvsTrafficRule property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dvsTrafficRule property.
     */
    public List<DvsTrafficRule> getDvsTrafficRule() {
        if (dvsTrafficRule == null) {
            dvsTrafficRule = new ArrayList<>();
        }
