...
/**
 * <p>Java class for ArrayOfHostNatService complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostNatService" type="{urn:internalvim25}HostNatService" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostNatService {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostNatService property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostNatService property.
     */
    public List<HostNatService> getHostNatService() {
        if (hostNatService == null) {
            hostNatService = new ArrayList<>();
        }
