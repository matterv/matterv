...
/**
 * <p>Java class for ArrayOfVirtualMachineScsiPassthroughInfo complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VirtualMachineScsiPassthroughInfo" type="{urn:internalvim25}VirtualMachineScsiPassthroughInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVirtualMachineScsiPassthroughInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachineScsiPassthroughInfo property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the virtualMachineScsiPassthroughInfo property.
     */
    public List<VirtualMachineScsiPassthroughInfo> getVirtualMachineScsiPassthroughInfo() {
        if (virtualMachineScsiPassthroughInfo == null) {
            virtualMachineScsiPassthroughInfo = new ArrayList<>();
        }
