...
/**
 * <p>Java class for ArrayOfAlarmAction complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="AlarmAction" type="{urn:internalvim25}AlarmAction" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfAlarmAction {
     ...
     * This is why there is not a <CODE>set</CODE> method for the alarmAction property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the alarmAction property.
     */
    public List<AlarmAction> getAlarmAction() {
        if (alarmAction == null) {
            alarmAction = new ArrayList<>();
        }
