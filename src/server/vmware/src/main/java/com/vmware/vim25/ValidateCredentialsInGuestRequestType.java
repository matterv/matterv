...
/**
 * <p>Java class for ValidateCredentialsInGuestRequestType complex type</p>.
 * 
...
@XmlType(name = "ValidateCredentialsInGuestRequestType", propOrder = {
    "_this",
    "vm",
    "auth"
})
public class ValidateCredentialsInGuestRequestType {
