...
/**
 * <p>Java class for ReleaseCredentialsInGuestRequestType complex type</p>.
 * 
...
@XmlType(name = "ReleaseCredentialsInGuestRequestType", propOrder = {
    "_this",
    "vm",
    "auth"
})
public class ReleaseCredentialsInGuestRequestType {
