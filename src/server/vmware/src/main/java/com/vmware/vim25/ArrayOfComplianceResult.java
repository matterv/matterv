...
/**
 * <p>Java class for ArrayOfComplianceResult complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="ComplianceResult" type="{urn:internalvim25}ComplianceResult" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfComplianceResult {
     ...
     * This is why there is not a <CODE>set</CODE> method for the complianceResult property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the complianceResult property.
     */
    public List<ComplianceResult> getComplianceResult() {
        if (complianceResult == null) {
            complianceResult = new ArrayList<>();
        }
