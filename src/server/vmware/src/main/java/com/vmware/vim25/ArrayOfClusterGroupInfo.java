...
/**
 * <p>Java class for ArrayOfClusterGroupInfo complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="ClusterGroupInfo" type="{urn:internalvim25}ClusterGroupInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfClusterGroupInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the clusterGroupInfo property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the clusterGroupInfo property.
     */
    public List<ClusterGroupInfo> getClusterGroupInfo() {
        if (clusterGroupInfo == null) {
            clusterGroupInfo = new ArrayList<>();
        }
