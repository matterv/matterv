...
/**
 * <p>Java class for UnmountVmfsVolumeRequestType complex type</p>.
 * 
...
@XmlType(name = "UnmountVmfsVolumeRequestType", propOrder = {
    "_this",
    "vmfsUuid"
})
public class UnmountVmfsVolumeRequestType {
