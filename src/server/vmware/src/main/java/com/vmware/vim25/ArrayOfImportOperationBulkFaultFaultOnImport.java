...
/**
 * <p>Java class for ArrayOfImportOperationBulkFaultFaultOnImport complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="ImportOperationBulkFaultFaultOnImport" type="{urn:internalvim25}ImportOperationBulkFaultFaultOnImport" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfImportOperationBulkFaultFaultOnImport {
     ...
     * This is why there is not a <CODE>set</CODE> method for the importOperationBulkFaultFaultOnImport property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the importOperationBulkFaultFaultOnImport property.
     */
    public List<ImportOperationBulkFaultFaultOnImport> getImportOperationBulkFaultFaultOnImport() {
        if (importOperationBulkFaultFaultOnImport == null) {
            importOperationBulkFaultFaultOnImport = new ArrayList<>();
        }
