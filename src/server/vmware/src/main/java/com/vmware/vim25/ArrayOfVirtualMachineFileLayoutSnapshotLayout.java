...
/**
 * <p>Java class for ArrayOfVirtualMachineFileLayoutSnapshotLayout complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VirtualMachineFileLayoutSnapshotLayout" type="{urn:internalvim25}VirtualMachineFileLayoutSnapshotLayout" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVirtualMachineFileLayoutSnapshotLayout {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualMachineFileLayoutSnapshotLayout property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the virtualMachineFileLayoutSnapshotLayout property.
     */
    public List<VirtualMachineFileLayoutSnapshotLayout> getVirtualMachineFileLayoutSnapshotLayout() {
        if (virtualMachineFileLayoutSnapshotLayout == null) {
            virtualMachineFileLayoutSnapshotLayout = new ArrayList<>();
        }
