...
/**
 * <p>Java class for CreateTemporaryFileInGuestRequestType complex type</p>.
 * 
...
@XmlType(name = "CreateTemporaryFileInGuestRequestType", propOrder = {
    "_this",
    "vm",
    "auth",
    "prefix",
...
public class CreateTemporaryFileInGuestRequestType {
