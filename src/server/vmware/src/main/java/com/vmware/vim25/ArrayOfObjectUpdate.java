...
/**
 * <p>Java class for ArrayOfObjectUpdate complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="ObjectUpdate" type="{urn:internalvim25}ObjectUpdate" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfObjectUpdate {
     ...
     * This is why there is not a <CODE>set</CODE> method for the objectUpdate property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the objectUpdate property.
     */
    public List<ObjectUpdate> getObjectUpdate() {
        if (objectUpdate == null) {
            objectUpdate = new ArrayList<>();
        }
