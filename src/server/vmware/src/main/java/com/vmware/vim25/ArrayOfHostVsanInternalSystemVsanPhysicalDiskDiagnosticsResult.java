...
/**
 * <p>Java class for ArrayOfHostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult" type="{urn:internalvim25}HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfHostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult property.
     */
    public List<HostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult> getHostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult() {
        if (hostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult == null) {
            hostVsanInternalSystemVsanPhysicalDiskDiagnosticsResult = new ArrayList<>();
        }
