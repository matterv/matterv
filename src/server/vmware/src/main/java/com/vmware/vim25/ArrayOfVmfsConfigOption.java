...
/**
 * <p>Java class for ArrayOfVmfsConfigOption complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="VmfsConfigOption" type="{urn:internalvim25}VmfsConfigOption" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfVmfsConfigOption {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vmfsConfigOption property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the vmfsConfigOption property.
     */
    public List<VmfsConfigOption> getVmfsConfigOption() {
        if (vmfsConfigOption == null) {
            vmfsConfigOption = new ArrayList<>();
        }
