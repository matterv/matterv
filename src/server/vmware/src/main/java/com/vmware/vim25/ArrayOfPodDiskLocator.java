...
/**
 * <p>Java class for ArrayOfPodDiskLocator complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="PodDiskLocator" type="{urn:internalvim25}PodDiskLocator" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfPodDiskLocator {
     ...
     * This is why there is not a <CODE>set</CODE> method for the podDiskLocator property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the podDiskLocator property.
     */
    public List<PodDiskLocator> getPodDiskLocator() {
        if (podDiskLocator == null) {
            podDiskLocator = new ArrayList<>();
        }
