...
/**
 * <p>Java class for ArrayOfPlacementSpec complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="PlacementSpec" type="{urn:internalvim25}PlacementSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfPlacementSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the placementSpec property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the placementSpec property.
     */
    public List<PlacementSpec> getPlacementSpec() {
        if (placementSpec == null) {
            placementSpec = new ArrayList<>();
        }
