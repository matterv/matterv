...
/**
 * <p>Java class for EnvironmentBrowserConfigOptionQuerySpec complex type</p>.
 * 
...
@XmlType(name = "EnvironmentBrowserConfigOptionQuerySpec", propOrder = {
    "key",
    "host",
    "guestId"
})
    ...
    extends DynamicData
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the guestId property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the guestId property.
     */
    public List<String> getGuestId() {
        if (guestId == null) {
            guestId = new ArrayList<>();
        }
        return this.guestId;
    }
