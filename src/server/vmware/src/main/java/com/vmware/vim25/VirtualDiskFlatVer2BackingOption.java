...
/**
 * <p>Java class for VirtualDiskFlatVer2BackingOption complex type</p>.
 * 
 ...
 *         <element name="thinProvisioned" type="{urn:internalvim25}BoolOption" minOccurs="0"/>
 *         <element name="eagerlyScrub" type="{urn:internalvim25}BoolOption" minOccurs="0"/>
 *         <element name="deltaDiskFormat" type="{urn:internalvim25}ChoiceOption" minOccurs="0"/>
 *         <element name="deltaDiskFormatsSupported" type="{urn:internalvim25}VirtualDiskDeltaDiskFormatsSupported" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
    ...
    extends VirtualDeviceFileBackingOption
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the deltaDiskFormatsSupported property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the deltaDiskFormatsSupported property.
     */
