...
/**
 * <p>Java class for ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="ClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots" type="{urn:internalvim25}ClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots {
     ...
     * This is why there is not a <CODE>set</CODE> method for the clusterDasFailoverLevelAdvancedRuntimeInfoVmSlots property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the clusterDasFailoverLevelAdvancedRuntimeInfoVmSlots property.
     */
    public List<ClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots> getClusterDasFailoverLevelAdvancedRuntimeInfoVmSlots() {
        if (clusterDasFailoverLevelAdvancedRuntimeInfoVmSlots == null) {
            clusterDasFailoverLevelAdvancedRuntimeInfoVmSlots = new ArrayList<>();
        }
