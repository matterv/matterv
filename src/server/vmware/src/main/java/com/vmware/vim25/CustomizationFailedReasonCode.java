 ...
 * 
 * 
 * <p>Java class for CustomizationFailedReasonCode</p>.
 * 
 ...
 *     <enumeration value="rawDataIsNotSupported"/>
 *     <enumeration value="wrongMetadataFormat"/>
 *   </restriction>
 * </simpleType>
 * }</pre>
 * 
...
public enum CustomizationFailedReasonCode {
    ...
    @XmlEnumValue("rawDataIsNotSupported")
    RAW_DATA_IS_NOT_SUPPORTED("rawDataIsNotSupported"),
    @XmlEnumValue("wrongMetadataFormat")
