...
/**
 * <p>Java class for BatchQueryConnectInfoRequestType complex type</p>.
 * 
 ...
 *         <element name="hostSpecs" type="{urn:internalvim25}HostConnectSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class BatchQueryConnectInfoRequestType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the hostSpecs property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the hostSpecs property.
     */
    public List<HostConnectSpec> getHostSpecs() {
        if (hostSpecs == null) {
            hostSpecs = new ArrayList<>();
        }
