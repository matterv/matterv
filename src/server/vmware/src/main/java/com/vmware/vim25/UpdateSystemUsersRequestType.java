...
/**
 * <p>Java class for UpdateSystemUsersRequestType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="UpdateSystemUsersRequestType">
 *   <complexContent>
...
@XmlType(name = "UpdateSystemUsersRequestType", propOrder = {
    "_this",
    "users"
})
