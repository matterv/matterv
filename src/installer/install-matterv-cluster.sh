...
install_from_network() {
  ...
  curl -L  -H "Authorization: Bearer ${token}"  -H "Accept: application/octet-stream" https://api.github.com/repos/matterv/matterv/releases/assets/211801746 -o /opt/matterv/matterv-cluster-0.6.tar.xz
